...
export default function IvrCampaign() {
  ...
  const generateIVR = () => {
    ...
    setTimeout(() => {
      ...
      if (form.language === "Hindi") {
        script = `RupeeDial me aapka swagat hai.

Agar aap ${form.city} me ${form.product} chahte hain to 1 dabayein.

Hamare executive se baat karne ke liye 2 dabayein.

Dhanyavaad.`;
      } else {
        script = `Welcome to RupeeDial.

If you are looking for ${form.product} in ${form.city}, press 1.

To speak with our executive, press 2.
...
Thank you for choosing RupeeDial.`;
      ...
      if (form.tone === "Local") {
        script += `\n\nSpecial assistance available for ${form.city} callers.`;
      }
  ...
  const launchCampaign = () => {
    ...
    const answered = Math.floor(calls * 0.75);
    const leads = Math.floor(answered * 0.3);

    setStats({ calls, answered, leads });
    setLaunched(true);
  };
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center gap-3">
        ...
        <PhoneCall className="text-emerald-600" />
        <h1 className="text-2xl font-semibold">IVR Campaign</h1>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white border border-emerald-100 rounded-2xl p-6 space-y-6 shadow-sm">
          ...
          <textarea
            ...
            placeholder="Generated IVR script..."
          />
          ...
          {launched && (
            <div className="text-sm text-emerald-600 font-medium">
              IVR Campaign Launched Successfully 🚀
            </div>
          )}
        </div>
        ...
        <div className="bg-white border border-emerald-100 rounded-2xl p-6 shadow-sm flex flex-col">
          ...
          <div className="flex flex-col items-center bg-gray-50 rounded-xl p-6 shadow-inner">
            ...
            <Volume2 className="text-emerald-600 w-8 h-8 mb-3" />
            ...
            <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4 text-sm whitespace-pre-wrap break-words w-full text-gray-700">
              {form.script ||
                "0s: Welcome to RupeeDial\n5s: Press 1 for Loan\n10s: Connect to Executive"}
            </div>
          </div>
